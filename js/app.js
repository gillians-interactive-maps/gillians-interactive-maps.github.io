...
const CATEGORY_ICONS = {
  ...
  vehicle_missions: `<path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 2c4.08 0 7.44 3.05 7.93 7h-4.04c-.41-1.16-1.52-2-2.89-2s-2.48.84-2.89 2H4.07C4.56 7.05 7.92 4 12 4zm-1 9c0-.55.45-1 1-1s1 .45 1 1-.45 1-1 1-1-.45-1-1zm-6.93 0h4.04c.33.94 1.07 1.68 2.01 2.01L8.8 19.33C6.34 18.06 4.6 15.75 4.07 13zm9.86 6.33l-1.32-2.32c.94-.33 1.68-1.07 2.01-2.01h4.04c-.53 2.75-2.27 5.06-4.73 6.33z"/>`,
