  ...
  categories: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "sj_trashmaster_portland", markerId: "sj_trashmaster_portland", subGroup: "Odd Jobs", title: "Trash Dash — Portland", giver: "Harwood Depot", island: "Portland", required: true, reward: "$2,000", coords: [-64.45, 101.65], desc: "Collect all dumpsters on Portland within the time limit." },
        ...
        { id: "sj_trashmaster_shoreside", markerId: "sj_trashmaster_shoreside", subGroup: "Odd Jobs", title: "Trash Dash — Shoreside Vale", giver: "Pike Creek Depot", island: "Shoreside", required: true, reward: "$4,000, Trashmaster Asset", coords: [-88.10, 38.40], desc: "Collect all dumpsters on Shoreside within the time limit." },
        ...
        { id: "race_torrington_tt", markerId: "bike_races_lcs_bike_races_1", subGroup: "Races", title: "Street Race: Torrington TT", giver: "Payphone (Torrington)", island: "Staunton", required: true, reward: "$1,500", coords: [-86.50, 68.50] },
        { id: "race_gangsta_gp", markerId: "bike_races_lcs_bike_races_2", subGroup: "Races", title: "Street Race: Gangsta GP", giver: "Payphone (Pike Creek)", island: "Shoreside", required: true, reward: "$1,500", coords: [-64.75, 31.95] },
        { id: "race_wi_cheetah", markerId: "car_races_lcs_car_races_2", subGroup: "Races", title: "Street Race: Wi-Cheetah Run", giver: "Payphone (Wichita Gardens)", island: "Shoreside", required: true, reward: "$1,500", coords: [-66.80, 43.20] },
