  ...
  categories: [
    {
      ...
      requiredFor100: true,
      items: [
        { id: "sm_home_sweet_home", title: "Home Sweet Home", giver: "Vincenzo Cilli", island: "Portland", required: true, reward: "Safehouse, Leone Clothes" },
        { id: "sm_slacker", title: "Slacker", giver: "Vincenzo Cilli", island: "Portland", required: true, reward: "$100" },
        { id: "sm_dealing_revenge", title: "Dealing Revenge", giver: "Vincenzo Cilli", island: "Portland", required: true, reward: "$500" },
        ...
        { id: "sm_don_in_60_seconds", title: "Don in 60 Seconds", giver: "JD O'Toole", island: "Portland", required: true, reward: "$1,000, Overalls" },
        ...
        { id: "sm_big_rumble_little_china", title: "Big Rumble in Little China", giver: "Ma Cipriani", island: "Portland", required: true, reward: "$0" },
        ...
        { id: "sm_the_offer", title: "The Offer", giver: "Vincenzo Cilli", island: "Portland", required: true, reward: "$500" },
        ...
        { id: "sm_driving_mr_leone", title: "Driving Mr. Leone", giver: "Salvatore Leone", island: "Portland", required: true, reward: "$4,000, Staunton Island Unlocked, Tuxedo" }
      ]
    },
    {
      id: "story_staunton",
      name: "Story Missions — Staunton Island (21)",
      ...
      items: [
        ...
        { id: "sm_sayonara_sindaccos", title: "Sayonara Sindaccos", giver: "Salvatore Leone", island: "Staunton", required: true, reward: "$1,500" },
        { id: "sm_the_whole_9_yards", title: "The Whole 9 Yards", giver: "Salvatore Leone", island: "Staunton", required: true, reward: "$2,000" },
        { id: "sm_crazy_69", title: "Crazy '69'", giver: "Salvatore Leone", island: "Staunton", required: true, reward: "$2,000, Dragon Jumpsuit" },
        { id: "sm_night_of_the_livid_dreads", title: "Night of the Livid Dreads", giver: "Salvatore Leone", island: "Staunton", required: true, reward: "$2,000" },
        { id: "sm_munition_salvation", title: "Munition Salvation", giver: "Salvatore Leone", island: "Staunton", required: true, reward: "$4,000" },
        { id: "sm_chopper_panic", title: "Chopper Panic", giver: "Salvatore Leone", island: "Staunton", required: true, reward: "$3,000" },
        { id: "sm_the_morgan_vance_hustle", title: "The Morgan Vance Hustle", giver: "Donald Love", island: "Staunton", required: true, reward: "$500" },
        { id: "sm_never_give_a_meanie", title: "Never Give a Meanie an Even Break", giver: "Donald Love", island: "Staunton", required: true, reward: "$1,000" },
        { id: "sm_lc_confidential", title: "L.C. Confidential", giver: "Ned Burner", island: "Staunton", required: true, reward: "$1,500, Lawyer Outfit" },
        ...
        { id: "sm_karmageddon", title: "Karmageddon", giver: "Ned Burner", island: "Staunton", required: true, reward: "$2,000, Firetruck Karmageddon Challenge" },
        { id: "sm_false_idols", title: "False Idols", giver: "Ned Burner", island: "Staunton", required: true, reward: "$1,500" },
        { id: "sm_search_and_seizure", title: "Search and Seizure", giver: "Leon McAffrey", island: "Staunton", required: true, reward: "$2,000" },
        { id: "sm_rollin_in_the_deep", title: "Rollin' in the Deep", giver: "Leon McAffrey", island: "Staunton", required: true, reward: "$2,000" },
        { id: "sm_say_cheese", title: "Say Cheese", giver: "Leon McAffrey", island: "Staunton", required: true, reward: "$2,000" },
        { id: "sm_snitch", title: "Snitch", giver: "Leon McAffrey", island: "Staunton", required: true, reward: "$2,000" },
        { id: "sm_steal_the_deal", title: "Steal the Deal", giver: "Donald Love", island: "Staunton", required: true, reward: "$1,500" },
        { id: "sm_the_guns_of_made_men", title: "The Guns of Made Men", giver: "Donald Love", island: "Staunton", required: true, reward: "$3,000" },
        { id: "sm_counterfeit_count", title: "Counterfeit Count", giver: "Donald Love", island: "Staunton", required: true, reward: "$2,500" },
        { id: "sm_love_on_the_rocks", title: "Love on the Rocks", giver: "Donald Love", island: "Staunton", required: true, reward: "Shoreside Vale Unlocked" }
      ]
    },
    {
      id: "story_shoreside",
      name: "Story Missions — Shoreside Vale (11)",
      icon: `<svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>`,
      requiredFor100: true,
      items: [
        { id: "sm_more_deadly_than_the_male", title: "More Deadly Than the Male", giver: "Toshiko Kasen", island: "Shoreside", required: true, reward: "$2,000" },
        { id: "sm_cash_in_kazukis_chips", title: "Cash in Kazuki's Chips", giver: "Toshiko Kasen", island: "Shoreside", required: true, reward: "$4,000, Wise Guy Outfit" },
        ...
        { id: "sm_shakedown", title: "Shakedown", giver: "Salvatore Leone", island: "Shoreside", required: true, reward: "$3,000" },
        { id: "sm_a_date_with_death", title: "A Date with Death", giver: "Toshiko Kasen", island: "Shoreside", required: true, reward: "$2,000, Tuxedo" },
        { id: "sm_the_sicilian_gambit", title: "The Sicilian Gambit (Final Story Mission)", giver: "Salvatore Leone", island: "Shoreside", required: true, reward: "$500,000, Antonio Outfit" }
      ]
    },
    {
      id: "collectibles",
    ...
    },
    {
      ...
      items: [
        ...
        { id: "vm_paramedic", markerId: "vm_paramedic", subGroup: "Vehicle Sub-Missions", title: "Paramedic (Level 12)", mobileTitle: "Paramedic (Level 9)", giver: "Ambulance", island: "All", required: true, reward: "Infinite Sprint", coords: [-88.50, 107.80], desc: "Complete Level 12 in an ambulance in one continuous run on any island.", mobileDesc: "Complete Level 9 in an ambulance in one continuous run on any island." },
        { id: "vm_firefighter", markerId: "vm_firefighter", subGroup: "Vehicle Sub-Missions", title: "Firefighter (Level 12)", mobileTitle: "Firefighter (Level 9)", giver: "Fire Truck", island: "All", required: true, reward: "Fireproof Toni", coords: [-62.10, 98.40], desc: "Extinguish 12 vehicle fires in a row in a fire truck on any island.", mobileDesc: "Extinguish 9 vehicle fires in a row in a fire truck on any island." },
        { id: "vm_vigilante", markerId: null, subGroup: "Vehicle Sub-Missions", title: "Vigilante (Level 12)", mobileTitle: "Vigilante (Level 9)", giver: "Police Car / Enforcer", island: "All", required: true, reward: "150 Maximum Armor", coords: null, desc: "Eliminate criminals up to Level 12 in a row in a police vehicle on any island.", mobileDesc: "Eliminate criminals up to Level 9 in a row in a police vehicle on any island." },
        { id: "vm_taxi", markerId: null, subGroup: "Vehicle Sub-Missions", title: "Taxi Driver (100 Total Fares)", giver: "Taxi / Cabbie", island: "All", required: true, reward: "Bickle '76 Taxi Unlocked at Mean Street Taxis", coords: null, desc: "Accumulate 100 fares total in any taxi or cabbie across Liberty City." },
        { id: "vm_pizza_delivery", markerId: "vm_pizza_delivery", subGroup: "Vehicle Sub-Missions", title: "Pizza Delivery (Level 10)", giver: "Joe's Pizza (St. Mark's)", island: "Portland", required: true, reward: "+25 Max Health", coords: [-81.28, 104.16], desc: "Deliver pizzas on the Pizza Boy scooter behind Joe's Pizza." },
        { id: "vm_noodle_delivery", markerId: "vm_noodle_delivery", subGroup: "Vehicle Sub-Missions", title: "Noodle Delivery (Level 10)", giver: "Punk Noodles (Chinatown)", island: "Portland", required: true, reward: "+25 Max Health", coords: [-88.75, 94.62], desc: "Deliver noodles on the Noodle Faggio in Chinatown." },
